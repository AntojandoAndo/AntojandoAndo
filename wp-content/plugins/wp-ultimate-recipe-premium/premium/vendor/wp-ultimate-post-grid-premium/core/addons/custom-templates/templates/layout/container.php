...
class WPUPG_Template_Container extends WPUPG_Template_Block {
    ...
    public function output( $post, $args = array() )
    {
        ...
        ob_start();
?>
<div id="wpupg-container-post-<?php echo $post->ID; ?>" data-id="<?php echo $post->ID; ?>" data-permalink="<?php echo esc_attr( $link ); ?>" data-custom-link="<?php echo esc_attr( $custom_link ); ?>" data-image="<?php echo esc_attr( $image_url ); ?>" <?php echo $this->style(); ?>>
